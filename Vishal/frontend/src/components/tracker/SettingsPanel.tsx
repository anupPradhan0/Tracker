      ...
      <Dialog open={open} onOpenChange={setOpen}>
        <DialogContent onClose={() => setOpen(false)} className="relative">
          ...
          <div className="space-y-4">
                ...
                <ul className="mb-2 space-y-1">
                  {fixedExpenses.map((expense, index) => (
                    <li
                      ...
                      className="chip-inset flex items-center justify-between gap-2 rounded-xl px-2 py-1.5 text-sm"
                    >
            ...
            <label className="chip-inset flex cursor-pointer items-center gap-3 rounded-xl p-3 transition-colors hover:bg-indigo-50/30">
              <input
                type="checkbox"
